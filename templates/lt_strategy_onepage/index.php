...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, default.css, slick.css, slick-theme.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.cookie.js, jquery.sticky.js, main.js, jquery.counterup.min.js, waypoints.min.js, jquery.easing.1.3.min.js, jquery.mixitup.min.js, jquery.stellar.min.js, wow.min.js, custom.js, slick.min.js, owl.carousel.js, owl.carousel.min.js, scroll.js, jquery.nav.js') // JS Files
